...
const config: Record<ReferenceStatus, { label: string; icon: React.ElementType; classes: string }> = {
  ready:      { label: 'Pronto',       icon: CheckCircle2, classes: 'text-success bg-success-muted border-success/30' },
  processing: { label: 'Processando',  icon: Loader2,      classes: 'text-warning bg-warning-muted border-warning/30 animate-pulse' },
  pending:    { label: 'Aguardando',   icon: Clock,        classes: 'text-muted-foreground bg-surface-muted/60 border-border' },
  error:      { label: 'Erro',         icon: AlertCircle,  classes: 'text-danger bg-danger-muted border-danger/30' },
