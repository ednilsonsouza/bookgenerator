...
const config: Record<ReferenceStatus, { label: string; icon: React.ElementType; classes: string }> = {
  ...
  pending:    { label: 'Aguardando',   icon: Clock,        classes: 'text-zinc-400 bg-zinc-800/60 border-zinc-700' },
  error:      { label: 'Erro',         icon: AlertCircle,  classes: 'text-red-400 bg-red-900/30 border-red-800' },
  no_file:    { label: 'Sem arquivo',  icon: FileX,        classes: 'text-zinc-500 bg-zinc-900 border-zinc-700' },
}
